...
public class AirPodsMax extends SinglePods {
    ...
    public int getDrawable () {
        switch (getColor()) {
            case "03": return Icons.AirPods_Max_SkyBlue;
            case "04": return Icons.AirPods_Max_Pink;
            case "06": return Icons.AirPods_Max_Silver;
            case "09": return Icons.AirPods_Max_SpaceGray;
            case "10": return Icons.AirPods_Max_Green; // Guess
            default: return Icons.AirPods_Max_Silver;
        }
    }
