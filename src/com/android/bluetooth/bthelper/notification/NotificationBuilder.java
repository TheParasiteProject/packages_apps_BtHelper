...
public class NotificationBuilder {
    ...
    public NotificationBuilder(Context context) {
        notificationArr = new RemoteViews[] {new RemoteViews(Constants.AUTHORITY_BTHELPER, R.layout.status_big), new RemoteViews(Constants.AUTHORITY_BTHELPER, R.layout.status_small)};

        mBuilder = new NotificationCompat.Builder(context, TAG);
        mBuilder.setShowWhen(false);
        mBuilder.setOngoing(true);
        mBuilder.setOnlyAlertOnce(true);
        mBuilder.setSmallIcon(R.drawable.ic_pod);
